...
Local dev keeps working through miniflare, which emulates D1, R2, Durable Objects, and cron locally; an app's server side must be exercisable with `pnpm dev` and no cloud resources.
